...
public class Game {
    ...
    public String checkGameWinner(char [][]grid) {
        ...
        //checking for win in columns and diagonals by progressing along them
        for (int i = 0; i < 3; i++) {    //remember i is like x axis
        ...
        //checking for win in rows by progressing along each y axis value's row
        for (int j = 0; j < 3; j++) {
